...
```{r setup-tibble}
team_data <- tibble(
  name = c("Me", "Akshit", "John", 
           "Aki"),
  github_username = c("Stavros-Michail", "akshitwadhawan", "John-heyward219", 
                      "BlemishControlFreak"), 
  colour = c("slateblue4", "blue", "blue", 
             "blue"),
  hobby = c("No Hobby", "Gaming", "Football", 
            "Rock Climbing"),
  favourite_number = c(14, 7, 11, 7)
  )
